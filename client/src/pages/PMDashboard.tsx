...
import { User, Mail, Briefcase, MapPin, LayoutDashboard, Users, CalendarCheck, DollarSign, ClipboardList, TrendingUp, AlertCircle, CheckCircle, Calendar, FileText, ChevronRight, ChevronDown, Plus, Minus, CheckSquare, Square, Lightbulb, AlertTriangle } from 'lucide-react';
...
const PMDashboard: React.FC = () => {
  ...
  const handleProjectClick = (project: any) => {
    if (project.status === 'initiate') {
      ...
      // For other statuses, show project details or navigate to project view
  ...
  const addSubtask = (parentTaskId: string, phaseId: string) => {
    const newSubtask = {
                ...
                <CardContent>
                                    ...
                                    <tr className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                      <td className="border border-gray-300 dark:border-gray-600 px-3 py-2 text-sm">
                                        <div className="flex items-center gap-2">
                                          ...
                                          {/* Add Subtask Button */}
                                          <button
                                            onClick={() => addSubtask(task.id, phase.id)}
                  ...
                  <div className="mt-4 space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <Button 
                        onClick={() => {
                          console.log('Saving updated dates:', editableDates);
                          alert('Dates saved successfully! (Check console for data)');
                        }}
