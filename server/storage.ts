...
export class MemStorage implements IStorage {
  ...
  async createProject(insertProject: InsertProject): Promise<Project> {
    ...
    const project: Project = {
      ...
      plannedStartDate: insertProject.plannedStartDate ?? null,
      plannedEndDate: insertProject.plannedEndDate ?? null,
      budgetAllocated: insertProject.budgetAllocated ?? null,
      budgetSpent: insertProject.budgetSpent ?? null,
      progressPercentage: insertProject.progressPercentage ?? null,
      createdAt: now,
      updatedAt: now
    };
